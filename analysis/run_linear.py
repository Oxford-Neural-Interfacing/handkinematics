'''
Evaluate linear methods on provided data
...
Defines analysis pipeline for assessing linear methods
'''
# Imports
import numpy as np

from routines_linear import *

# Define linear analyses to run
def run_linear(data:dict, flags:dict) -> dict:
    '''
    Evaluates performance of PCA for reconstruction, classification and interpolation using provided data
    ...
    reconstruction_results = reconstruct_linear(data, args)
    
    # Assess classification accuracy
    print("\t\tAssessing classification performance...")
    classification_results = classify_linear(data, args)
    
    # Assess interpolation accuracy
    print("\t\tAssessing interpolation accuracy...")
    interpolation_results = interpolate_linear(data, args)
